...
<div class="container" id="content">
    ...
    <div class="banner" style="display: flex-inline; justify-content: center; height: 70px; width: 1140px; margin-top: -30px; margin-bottom: -2px; border-radius: 50px; border: 1px solid lightblue; background-image: url(banner5.jpg); background-size: cover;">
        ...
        <center><p style="color: black; font-weight: normal; font-size: 15px; user-select: none;">Choose among the best mens gears.</p></center>
    </div>
    <hr style="border: 1px solid lightblue; margin-bottom: 35px;">

    <?php
    $query = "SELECT filepath, pname, price, products.pid FROM products JOIN product_varients ON products.pid = product_varients.pid WHERE pgender='Male' GROUP BY products.pid ORDER BY time DESC LIMIT 10";
